...
<%@ include file="/include/header.jsp"%>
	...
	<section class="home-slider owl-carousel img"
		style="background-image: url(template/images/bg_1.jpg);">
			...
			<div class="container">
				<div class="row slider-text align-items-center"
					...
					<div class="col-md-6 ftco-animate">
						<img src="template/images/bg_1.png" class="img-fluid" alt="">
					</div>
		...
		<div class="slider-item">
			...
			<div class="container">
				<div class="row slider-text align-items-center"
					...
					<div class="col-md-6 ftco-animate">
						<img src="template/images/bg_2.png" class="img-fluid" alt="">
					</div>
		...
		<div class="slider-item"
			style="background-image: url(template/images/bg_3.jpg);">
			<div class="overlay"></div>
			<div class="container">
				<div
	...
	<section class="ftco-about d-md-flex">
		<div class="one-half img"
			style="background-image: url(template/images/about.jpg);"></div>
	...
	<section class="ftco-section">
	    ...
	    <div class="row no-gutters d-flex">
	        ...
	        <div class="col-lg-4 d-flex align-items-stretch ftco-animate">
	            <div class="services-wrap d-flex flex-column">
	                <img src="<%= pizza.getImage() %>" class="img img-fluid">
	                <div class="text p-4 d-flex flex-column justify-content-between">
	                    <h3><%= pizza.getName() %></h3>
	                    <p><%= pizza.getDescription() %></p>
	                    <p class="price">
	                        <span><%= pizza.getPrice() %> DT</span>
	                        <a href="PizzaDetailController?pizzaId=<%= pizza.getId() %>" class="ml-2 btn btn-white btn-outline-white">Order</a>
	                    </p>
	                </div>
	            </div>
	        </div>
			...
			<div class="row">
				<div class="col-md-6">
					<div class="pricing-entry d-flex ftco-animate">
						<div class="img"
							style="background-image: url(template/images/pizza-1.jpg);"></div>
						<div class="desc pl-3">
					...
					<div class="pricing-entry d-flex ftco-animate">
						<div class="img"
							style="background-image: url(template/images/pizza-2.jpg);"></div>
						<div class="desc pl-3">
							<div class="d-flex text align-items-center">
								<h3>
					...
					<div class="pricing-entry d-flex ftco-animate">
						<div class="img"
							style="background-image: url(template/images/pizza-3.jpg);"></div>
						<div class="desc pl-3">
							<div class="d-flex text align-items-center">
								<h3>
					...
					<div class="pricing-entry d-flex ftco-animate">
						<div class="img"
							style="background-image: url(template/images/pizza-4.jpg);"></div>
						<div class="desc pl-3">
							<div class="d-flex text align-items-center">
								<h3>
				...
				<div class="col-md-6">
					<div class="pricing-entry d-flex ftco-animate">
						<div class="img"
							style="background-image: url(template/images/pizza-5.jpg);"></div>
						<div class="desc pl-3">
							<div class="d-flex text align-items-center">
								<h3>
					...
					<div class="pricing-entry d-flex ftco-animate">
						<div class="img"
							style="background-image: url(template/images/pizza-6.jpg);"></div>
						<div class="desc pl-3">
							<div class="d-flex text align-items-center">
								<h3>
					...
					<div class="pricing-entry d-flex ftco-animate">
						<div class="img"
							style="background-image: url(template/images/pizza-7.jpg);"></div>
						<div class="desc pl-3">
							<div class="d-flex text align-items-center">
								<h3>
					...
					<div class="pricing-entry d-flex ftco-animate">
						<div class="img"
							style="background-image: url(template/images/pizza-8.jpg);"></div>
						<div class="desc pl-3">
							<div class="d-flex text align-items-center">
								<h3>
			...
			<div class="row no-gutters">
				<div class="col-md-3 ftco-animate">
					<a href="#" class="gallery img d-flex align-items-center"
						style="background-image: url(template/images/gallery-1.jpg);">
						<div
				...
				<div class="col-md-3 ftco-animate">
					<a href="#" class="gallery img d-flex align-items-center"
						style="background-image: url(template/images/gallery-2.jpg);">
						<div
							class="icon mb-4 d-flex align-items-center justify-content-center">
							<span class="icon-search"></span>
						</div>
				...
				<div class="col-md-3 ftco-animate">
					<a href="#" class="gallery img d-flex align-items-center"
						style="background-image: url(template/images/gallery-3.jpg);">
						<div
							class="icon mb-4 d-flex align-items-center justify-content-center">
							<span class="icon-search"></span>
						</div>
				...
				<div class="col-md-3 ftco-animate">
					<a href="#" class="gallery img d-flex align-items-center"
						style="background-image: url(template/images/gallery-4.jpg);">
						<div
							class="icon mb-4 d-flex align-items-center justify-content-center">
							<span class="icon-search"></span>
						</div>
	...
	<section class="ftco-counter ftco-bg-dark img" id="section-counter"
		style="background-image: url(template/images/bg_2.jpg);"
						...
						<div class="col-md-12 nav-link-wrap mb-5">
							<div class="nav ftco-animate nav-pills" id="v-pills-tab"
								...
								<a class="nav-link active" id="v-pills-1-tab" data-toggle="pill"
									...
									aria-selected="true">Pizza</a> <a class="nav-link"
								...
								<a class="nav-link" id="v-pills-3-tab" data-toggle="pill"
									...
									aria-selected="false">Burgers</a> <a class="nav-link"
									id="v-pills-4-tab" data-toggle="pill" href="#v-pills-4"
								...
								<div class="tab-pane fade show active" id="v-pills-1"
									...
									<div class="row">
										<div class="col-md-4 text-center">
											<div class="menu-wrap">
												<a href="#" class="menu-img img mb-4"
													style="background-image: url(template/images/pizza-1.jpg);"></a>
												<div class="text">
													<h3>
													...
													<p>
														<a href="#" class="btn btn-white btn-outline-white">Add
															to cart</a>
													</p>
												</div>
											</div>
										...
										<div class="col-md-4 text-center">
											<div class="menu-wrap">
												<a href="#" class="menu-img img mb-4"
													style="background-image: url(template/images/pizza-2.jpg);"></a>
												<div class="text">
													<h3>
														<a href="#">Itallian Pizza</a>
													</h3>
										...
										<div class="col-md-4 text-center">
											<div class="menu-wrap">
												<a href="#" class="menu-img img mb-4"
													style="background-image: url(template/images/pizza-3.jpg);"></a>
												<div class="text">
													<h3>
														<a href="#">Itallian Pizza</a>
													</h3>
								...
								<div class="tab-pane fade" id="v-pills-2" role="tabpanel"
									...
									<div class="row">
										<div class="col-md-4 text-center">
											<div class="menu-wrap">
												<a href="#" class="menu-img img mb-4"
													style="background-image: url(template/images/drink-1.jpg);"></a>
												<div class="text">
													<h3>
										...
										<div class="col-md-4 text-center">
											<div class="menu-wrap">
												<a href="#" class="menu-img img mb-4"
													style="background-image: url(template/images/drink-2.jpg);"></a>
												<div class="text">
													<h3>
										...
										<div class="col-md-4 text-center">
											<div class="menu-wrap">
												<a href="#" class="menu-img img mb-4"
													style="background-image: url(template/images/drink-3.jpg);"></a>
												<div class="text">
													<h3>
								...
								<div class="tab-pane fade" id="v-pills-3" role="tabpanel"
									...
									<div class="row">
										<div class="col-md-4 text-center">
											<div class="menu-wrap">
												<a href="#" class="menu-img img mb-4"
													style="background-image: url(template/images/burger-1.jpg);"></a>
												<div class="text">
													<h3>
														<a href="#">Itallian Pizza</a>
													</h3>
										...
										<div class="col-md-4 text-center">
											<div class="menu-wrap">
												<a href="#" class="menu-img img mb-4"
													style="background-image: url(template/images/burger-2.jpg);"></a>
												<div class="text">
													<h3>
														<a href="#">Itallian Pizza</a>
													</h3>
										...
										<div class="col-md-4 text-center">
											<div class="menu-wrap">
												<a href="#" class="menu-img img mb-4"
													style="background-image: url(template/images/burger-3.jpg);"></a>
												<div class="text">
													<h3>
														<a href="#">Itallian Pizza</a>
													</h3>
								...
								<div class="tab-pane fade" id="v-pills-4" role="tabpanel"
									...
									<div class="row">
										<div class="col-md-4 text-center">
											<div class="menu-wrap">
												<a href="#" class="menu-img img mb-4"
													style="background-image: url(template/images/pasta-1.jpg);"></a>
												<div class="text">
													<h3>
														<a href="#">Itallian Pizza</a>
													</h3>
										...
										<div class="col-md-4 text-center">
											<div class="menu-wrap">
												<a href="#" class="menu-img img mb-4"
													style="background-image: url(template/images/pasta-2.jpg);"></a>
												<div class="text">
													<h3>
														<a href="#">Itallian Pizza</a>
													</h3>
										...
										<div class="col-md-4 text-center">
											<div class="menu-wrap">
												<a href="#" class="menu-img img mb-4"
													style="background-image: url(template/images/pasta-3.jpg);"></a>
												<div class="text">
													<h3>
														<a href="#">Itallian Pizza</a>
													</h3>
